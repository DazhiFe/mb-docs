...
- PC平台单张的图片的大小尽量不大于 200KB
- 移动平台单张的图片的大小尽量不大于 100KB


## 图片质量

- 上线的图片都应该经过压缩处理，压缩后的图片不应该出现肉眼可感知的失真区域
- 60质量的JPEG格式图片与质量大于60的相比，肉眼已看不出明显的区别，因此保存 JPEG 图的时候，质量一般控制在60，若保真度要求高的图片可适量提高到 80，图片大小尽量控制在 200KB 以内
...
未来趋势，PC端不考虑低版本浏览器兼容性的话推荐使用，移动端放心使用
